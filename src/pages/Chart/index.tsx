...
export default function Chart() {
  ...
  const handlerChangePart = function (part: string) {
    if (part === "cabeca") {
      ...
      console.log(dados.current.mediaTodos);
      ...
      setData([
        ...dados.current._pontosCabeca,
        ...dados.current._pontosCauda,
        ...dados.current._pontosCoracao,
      ]);
    }
  };
  ...
  return (
    ...
    >
      <Box className="title-charts-page">
      ...
      <Box className="chart-warp">
        {checked ? (
          <TwoCharts compacto={!expandir} data={data} />
        ) : (
          <TwoSameArea compacto={!expandir} data={data} />
        )}
      </Box>
      <Box className="options-warp-chart">
        <Box
          sx={{
            display: "flex",
          }}
        ...
        <Box className="switch-charts-warp">
        ...
        <Box className="options-pagination">
          {/*
						<ButtonBase>
							<ArrowBack />
	    Voltar
